...
class EmbeddingSegmentsSumCPUTest : public testing::WithParamInterface<embeddingSegmentsSumLayerTestParamsSet>,
...
TEST_P(EmbeddingSegmentsSumCPUTest, CompareWithRefs) {
...
INSTANTIATE_TEST_SUITE_P(smoke, EmbeddingSegmentsSumCPUTest,
     ::testing::Combine(
             embSegmentsSumArgSet,
             ::testing::ValuesIn(netPrecisions),
             ::testing::ValuesIn(indPrecisions),
             ::testing::Values(CommonTestUtils::DEVICE_CPU)),
             EmbeddingSegmentsSumCPUTest::getTestCaseName);
