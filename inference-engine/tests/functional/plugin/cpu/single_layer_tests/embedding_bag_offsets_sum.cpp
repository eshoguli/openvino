...
class EmbeddingBagOffsetsSumCPUTest : public testing::WithParamInterface<embeddingBagOffsetsSumLayerTestParamsSet>,
...
TEST_P(EmbeddingBagOffsetsSumCPUTest, CompareWithRefs) {
...
INSTANTIATE_TEST_SUITE_P(smoke, EmbeddingBagOffsetsSumCPUTest,
     ::testing::Combine(
             embBagOffsetSumArgSet,
             ::testing::ValuesIn(netPrecisions),
             ::testing::ValuesIn(indPrecisions),
             ::testing::Values(CommonTestUtils::DEVICE_CPU)),
             EmbeddingBagOffsetsSumCPUTest::getTestCaseName);
