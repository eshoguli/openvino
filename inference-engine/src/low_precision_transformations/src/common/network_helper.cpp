...
NetworkHelper::InsertDequantizationResult NetworkHelper::moveDequantizationAfter(
    ...
    if (moveSubtract && (dequantization.subtract != nullptr)) {
        ...
        const element::Type parentPrecision = dequantization.subtract->get_input_element_type(0);
    ...
    if (dequantization.multiply != nullptr) {
        ...
        const element::Type parentPrecision = dequantization.multiply->get_input_element_type(0);
