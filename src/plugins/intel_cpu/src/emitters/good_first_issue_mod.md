...
CPU plugin JIT emitters implement element-wise operations. Use [CPU plugin JIT emitters](https://github.com/eshoguli/openvino/blob/es/cpu/emitters_doc/src/plugins/intel_cpu/src/emitters/README.md) documentation for details.
...
Before development, please, modify tests to be sure that deveoped functionality is covered by test:
