...
public:
    jit_memory_emitter(ov::intel_cpu::riscv64::jit_generator* h,
...
public:
    jit_load_memory_emitter(ov::intel_cpu::riscv64::jit_generator* h,
                            ov::intel_cpu::riscv64::cpu_isa_t isa,
                            const ov::snippets::lowered::ExpressionPtr& expr);
...
public:
    jit_load_broadcast_emitter(ov::intel_cpu::riscv64::jit_generator* h,
                               ov::intel_cpu::riscv64::cpu_isa_t isa,
                               const ov::snippets::lowered::ExpressionPtr& expr);
...
public:
    jit_store_memory_emitter(ov::intel_cpu::riscv64::jit_generator* h,
                             ov::intel_cpu::riscv64::cpu_isa_t isa,
                             const ov::snippets::lowered::ExpressionPtr& expr);
