...
public:
    jit_kernel_emitter(ov::intel_cpu::riscv64::jit_generator* h, ov::intel_cpu::riscv64::cpu_isa_t isa, const ov::snippets::lowered::ExpressionPtr& expr);
...
protected:
    ...
    */
    ...
    virtual void init_data_pointers(const std::vector<Xbyak_riscv::Reg>& data_ptr_regs) const = 0;
...
public:
    jit_kernel_static_emitter(ov::intel_cpu::riscv64::jit_generator* h,
                              ov::intel_cpu::riscv64::cpu_isa_t isa, const ov::snippets::lowered::ExpressionPtr& expr);

private:
    void init_data_pointers(const std::vector<Xbyak_riscv::Reg>& data_ptr_regs) const override;
...
public:
    jit_kernel_dynamic_emitter(ov::intel_cpu::riscv64::jit_generator* h,
