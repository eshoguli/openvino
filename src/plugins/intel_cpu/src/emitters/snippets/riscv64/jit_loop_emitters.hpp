...
public:
    jit_loop_begin_emitter(ov::intel_cpu::riscv64::jit_generator* h,
    ...
    std::shared_ptr<const Xbyak_riscv::Label> get_begin_label() { return loop_begin_label; }

protected:
    void validate_arguments(const std::vector<size_t> &in, const std::vector<size_t> &out) const override;
    void emit_impl(const std::vector<size_t>& in, const std::vector<size_t>& out) const override;

    std::shared_ptr<Xbyak_riscv::Label> loop_begin_label;
...
public:
    jit_loop_end_emitter(ov::intel_cpu::riscv64::jit_generator* h,
                         ov::intel_cpu::riscv64::cpu_isa_t isa,
                         const ov::snippets::lowered::ExpressionPtr& expr);
...
protected:
    ...
    std::shared_ptr<const Xbyak_riscv::Label> loop_begin_label;
    size_t num_inputs = 0;
