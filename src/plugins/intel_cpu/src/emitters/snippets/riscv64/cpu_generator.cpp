...
#include "emitters/snippets/riscv64/jit_kernel_emitter.hpp"
#include "emitters/snippets/riscv64/jit_loop_emitters.hpp"
#include "emitters/snippets/riscv64/jit_memory_emitters.hpp"
#include "emitters/snippets/riscv64/jit_fill_emitter.hpp"
...
class jit_snippet : public ov::intel_cpu::riscv64::jit_generator {
public:
...
CompiledSnippetCPU::CompiledSnippetCPU(std::unique_ptr<ov::intel_cpu::riscv64::jit_generator> h) : h_compiled(std::move(h)) {
...
CPUTargetMachine::CPUTargetMachine(ov::intel_cpu::riscv64::cpu_isa_t host_isa)
...
size_t CPUTargetMachine::get_lanes() const {
    switch (isa) {
        case ov::intel_cpu::riscv64::asimd : return ov::intel_cpu::riscv64::cpu_isa_traits<ov::intel_cpu::riscv64::asimd>::vlen / sizeof(float);
...
CPUGenerator::CPUGenerator(ov::intel_cpu::riscv64::cpu_isa_t isa_) : Generator(std::make_shared<CPUTargetMachine>(isa_)) {}
