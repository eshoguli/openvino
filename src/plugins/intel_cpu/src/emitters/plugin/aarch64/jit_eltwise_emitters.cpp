...
void jit_gelu_tanh_emitter::register_table_entries() {
    ...
    push_arg_entry_of("half", 0x3f000000, true, exec_prc_);
    push_arg_entry_of("gelu_tanh_fitting_const", 0x3d372713, true, exec_prc_);
    push_arg_entry_of("gelu_tanh_fitting_const_times_three", 0x3e095d4f, true, exec_prc_);
    push_arg_entry_of("gelu_tanh_sqrt_two_over_pi", 0x3f4c422a, true, exec_prc_);
}
...
void jit_mish_emitter::register_table_entries() {
    ...
    push_arg_entry_of("bwd_mish_max_x_for_equation_f", float2int(22.1807079, exec_prc_), true, exec_prc_);
}
