...
std::set<std::vector<InferenceEngine::Precision>> jit_add_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
...
std::set<std::vector<InferenceEngine::Precision>> jit_subtract_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}, {Precision::I32, Precision::I32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_multiply_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}, {Precision::I32, Precision::I32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_divide_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}, {Precision::I32, Precision::I32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_floor_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
...
std::set<std::vector<InferenceEngine::Precision>> jit_ceiling_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_floor_mod_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_mod_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_maximum_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}, {Precision::I32, Precision::I32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_minimum_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}, {Precision::I32, Precision::I32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_squared_difference_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}, {Precision::I32, Precision::I32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_power_dynamic_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_equal_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_not_equal_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_greater_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{Precision::FP32, Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_greater_equal_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return { {InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32} };
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_less_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_less_equal_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_logical_and_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_logical_or_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_logical_xor_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_logical_not_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_power_static_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_prelu_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_sqrt_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_negative_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_erf_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_soft_sign_emitter::get_supported_precisions() {
    return {{InferenceEngine::Precision::FP32}};
}
...
std::set<std::vector<InferenceEngine::Precision>> jit_select_emitter::get_supported_precisions(const std::shared_ptr<ngraph::Node>& node) {
    return {{InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32, InferenceEngine::Precision::FP32}};
}
