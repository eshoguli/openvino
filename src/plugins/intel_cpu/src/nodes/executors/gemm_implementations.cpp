...
#include "nodes/executors/acl/acl_matmul.hpp"
#endif
    ...
    static const std::vector<ExecutorImplementation<GEMMAttrs>> gemmImplementations {
        OV_CPU_INSTANCE_ACL(
            ...
            [](const GEMMConfig& config) -> bool {
                ...
                return ACLMatMulExecutor::supports(config);
            },
            // requiresFallback
            ...
            [](const GEMMAttrs& attrs,
               ...
               const ExecutorContext::CPtr context) {
                return std::make_shared<ACLMatMulExecutor>(attrs, postOps, memory, context);
            })
    };
