...
//                const auto src_ptr = static_cast<const float16*>(args_ptrs.src_ptr[source_i]);
//                for (size_t i = 0; i < 16; i++) {
//                    std::cout << i << ": " << static_cast<float16>(src_ptr[i]) << std::endl;
//                }
...
//        }
        ...
        //std::cout << "fused_operations = " << ov::intel_cpu::aarch64::fused_operations << std::endl;
...
//            const auto src_ptr = static_cast<const float16*>(args_ptrs.dst_ptr);
//            for (size_t i = 0; i < 16; i++) {
//                std::cout << i << ": " << static_cast<float16>(src_ptr[i]) << std::endl;
//            }
//            std::cout << std::endl << std::endl;
