...
void Eltwise::execute(dnnl::stream strm) {
    if (execPtr) {
...

        {
            ...
            for (size_t source_i = 0; source_i < memPtrs.size() - 1; source_i++) {
                ...
                for (size_t i = 0; i < length; i++) {
                    int v = static_cast<uint8_t>(src_ptr[i]);
                    std::cout << v << ", ";
                }
        ...
        if (std::dynamic_pointer_cast<EltwiseJitExecutor>(execPtr) != nullptr) {
            ...
            (std::dynamic_pointer_cast<BitwiseRefExecutor<int8_t>>(execPtr) != nullptr) ||
            (std::dynamic_pointer_cast<BitwiseRefExecutor<uint8_t>>(execPtr) != nullptr) ||
            (std::dynamic_pointer_cast<BitwiseRefExecutor<int16_t>>(execPtr) != nullptr) ||
            (std::dynamic_pointer_cast<BitwiseRefExecutor<int32_t>>(execPtr) != nullptr)) {
...

        {
            ...
            for (size_t i = 0; i < length; i++) {
                int v = static_cast<int8_t>(src_ptr[i]);
                std::cout << v << ", ";
            }
            std::cout << std::endl << std::endl;
        }
