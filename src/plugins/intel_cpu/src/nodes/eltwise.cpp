...
namespace func {
float reference(const float value) {
//    const auto sigmoid = [](const float value) {
...
//        //if (this->getAlgorithm() == Algorithm::EltwiseExp) {
//        {
//            // TODO: debug
...
////                if (this->getAlgorithm() == Algorithm::EltwiseExp) {
//                {
//                    const auto ref = func::reference(inputs[i]);
//                    std::cout << i << ": in: " << inputs[i] << ", act: " << src_ptr[i] << ", ref: " << ref
//                              << ", diff: " << (ref != 0.0 ? std::to_string(::abs((ref - src_ptr[i]) / ref)) : "n/a")
//                              << std::endl;
//                }
////                else {
////                    std::cout << src_ptr[i] << " ";
