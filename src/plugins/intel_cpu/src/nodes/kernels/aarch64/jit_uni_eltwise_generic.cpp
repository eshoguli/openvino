...
void jit_uni_eltwise_generic<isa>::load_vector(const TReg& data,
    ...
    switch (src_prc) {
        ...
        case ov::element::i8:
        case ov::element::u8: {
            utils::load_vector(data.b, data.b8, ptr_reg, ptr_offset, broadcast, this);
            break;
        }
        // case ov::element::i8:
        // case ov::element::u8: {
        ...
        //         }
        //     } else {
        //         // workaround: ld1 for 4 bytes are not implemented
        //         // ld1(data.b4, Xbyak_aarch64::ptr(ptr_reg));
        //         const auto load_byte = [&](
        //                 jit_generator* h,
        //                 const size_t i,
        //                 const int32_t offset) {
        //             add_imm(X_DEFAULT_ADDR, ptr_reg, offset, X_TMP_0);
        //             h->ld1(data.b[i], Xbyak_aarch64::ptr(X_DEFAULT_ADDR));
        //         };

        //         if (offset == 0) {
        //             ld1(data.b[0], Xbyak_aarch64::ptr(ptr_reg));
        //             load_byte(this, 1, 1);
        //             load_byte(this, 2, 2);
        //             load_byte(this, 3, 3);
        //         } else {
        //             load_byte(this, 0, offset);
        //             load_byte(this, 1, offset + 1);
        //             load_byte(this, 2, offset + 2);
        //             load_byte(this, 3, offset + 3);
        //         }
        //     }
        //     break;
        // }
