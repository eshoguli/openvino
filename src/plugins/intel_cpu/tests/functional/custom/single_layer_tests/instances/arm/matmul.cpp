...
const std::vector<ov::AnyMap>& armAdditionalConfig() {
    static std::vector<ov::AnyMap> armAdditionalConfig{
        {ov::hint::inference_precision(ov::element::f16)}};
    return armAdditionalConfig;
}
...
const auto testParams2D_smoke_f16 = ::testing::Combine(::testing::Combine(::testing::ValuesIn(IS2D_smoke()),
                                                                      ...
                                                                      ::testing::Values(utils::InputLayerType::CONSTANT),
                                                                      ::testing::Values(ov::test::utils::DEVICE_CPU),
                                                                      ::testing::Values(armAdditionalConfig()[0])),
                                                   ::testing::Values(MatMulNodeType::FullyConnected),
