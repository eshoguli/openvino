...
typedef std::pair<std::function<std::shared_ptr<Emitter>(const std::shared_ptr<ngraph::Node>&)>,
                  std::function<std::set<std::vector<InferenceEngine::Precision>>(const std::shared_ptr<ngraph::Node>&)>> jitters_value;
/**
...
public:
    ...
    std::function<std::set<std::vector<InferenceEngine::Precision>>(const std::shared_ptr<ngraph::Node>&)>
