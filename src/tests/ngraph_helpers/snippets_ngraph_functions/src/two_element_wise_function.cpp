...
std::shared_ptr<ngraph::Function> TwoElementWiseFunction::get(
...
std::shared_ptr<ov::Model> TwoElementWiseFunction::initOriginal() const {
    return get(
        precision1,
        input_shapes[0],
        precision2,
...
std::shared_ptr<ov::Model> TwoElementWiseFunction::initReference() const {
    return get(
        precision1,
        input_shapes[0],
        precision2,
