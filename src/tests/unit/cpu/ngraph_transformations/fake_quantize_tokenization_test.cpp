...
TEST_F(FakeQuantizeTokenizationTest, smoke_Snippets_FakeQuantize_PerTensor) {
    ...
    function_ref = FakeQuantizeFunction::getSubgraphWithFakeQuantize(
        ...
        { {}, {}, {}, {} },
        true,
        FunctionHelper::makePrerequisites(),
        {
            std::make_shared<ngraph::opset1::PRelu>(
                std::make_shared<ngraph::opset1::Parameter>(),
                std::make_shared<ngraph::opset1::Constant>(ov::element::f32, ov::Shape{}, std::vector<float>{-1.f})),
        });
...
TEST_F(FakeQuantizeTokenizationTest, smoke_Snippets_FakeQuantize_PerChannels) {
    ...
    function_ref = FakeQuantizeFunction::getOperationAndFakeQuantize(
        ...
        { {1, 3, 1, 1}, {1, 3, 1, 1}, {1, 3, 1, 1}, {1, 3, 1, 1} },
        true,
        FunctionHelper::makePrerequisitesReference());
...
//TEST_F(FakeQuantizeTokenizationTest, smoke_Snippets_MatMulWithMatFakeQuantize) {
//    function = FakeQuantizeFunction::getOperationAndFakeQuantize(
//        {{8, 64, 16}, {8, 16, 64}},
//        element::f32,
//        {{}, {}, {}, {}},
//        true,
//        FakeQuantizeFunction::makePrerequisitesOriginal(ngraph::Shape{ 1, 3, 16, 16 }, element::f32),
//        std::make_shared<ngraph::opset1::MatMul>());
//
//    function_ref = FakeQuantizeFunction::getOperationAndFakeQuantize(
//        {{8, 64, 16}, {8, 16, 64}},
//        element::f32,
//        {{}, {}, {}, {}},
//        true,
//        FakeQuantizeFunction::makePrerequisitesReference(ngraph::Shape{ 1, 3, 16, 16 }, element::f32),
//        std::make_shared<ngraph::opset1::MatMul>());
//
//    register_passes();
//}
